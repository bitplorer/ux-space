...
class SoftSurfaceExampleTests(unittest.TestCase):
    ...
    def test_example_composes_soft3_camera_light(self) -> None:
        ...
        self.assertEqual(by_id["eye"]["orbit"], {"azimuth": 0.0, "polar": 1.35})
        self.assertEqual(by_id["eye"]["pan"], {"x": 0.0, "y": 0.2})
        self.assertEqual(by_id["eye"]["zoom"], 7.2)
    ...
    def test_example_composes_soft4_transform_and_material(self) -> None:
        ...
        self.assertEqual(box["material"]["type"], "standard")
        self.assertEqual(box["material"]["map"], "stripe")
    ...
    def test_example_composes_soft9_loaders(self) -> None:
        ...
        self.assertEqual(by_id["box"]["material"]["map"], "stripe")
